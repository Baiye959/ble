...
import com.baiye959.ble.MainActivity
...
object ECBLE {
    ...
    fun openBluetoothAdapter(ctx: MainActivity) {
    ...
    fun onPermissionsGranted(ctx: MainActivity, requestCode: Int, perms: List<String?>) {
